...
public class MiningOperation extends Application {
     ...
     */
    Button mineRockBtn, purchaseWorkerBtn, purchaseDrillBtn;
    Label upgradesSectionLabel, buildingsSectionLabel;
    TextField score;

    UpgradeImageView laserUpgImage, sunglassesUpgImage, pickaxeUpgImage;
    ...
    private void upgradePick(){
        ...
        if (missing_price <= 0) {
            ...
            if ((rockFactory.getPickaxeStrength() - 1) <= 4){
    ...
    public void start(Stage stage) throws FileNotFoundException {
        ...
        root.getChildren().addAll(canvas, mineRockBtn, score, purchaseWorkerBtn, purchaseDrillBtn);
        root.getChildren().addAll(upgradesSectionLabel, buildingsSectionLabel, sunglassesUpgImage, laserUpgImage, pickaxeUpgImage);
        ...
        gameLoop.schedule(new TimerTask() {
            ...
            public void run() {
                Platform.runLater(() -> {
                    ...
                    // Redraw income
                    gc.drawImage(paperBkgd, 0, 0, 150, 300);
    ...
    private void generateUpgrades(){
        sunglassesUpgImage = new UpgradeImageView(490, 185, 16, 16, sunglassesUpg);
        ...
        laserUpgImage = new UpgradeImageView(538, 185, 16, 16, laserUpg);
        ...
        pickaxeUpgImage = new UpgradeImageView(442, 185, 16, 16, rockFactory.getNextPickaxe().getImage());
